...
template <> struct NameTraits<void> {
  static constexpr const char *text = "void";
};

template <> struct NameTraits<bool> {
...
template <> struct NameTraits<short> {
  static constexpr const char *text = "short";
};

template <> struct NameTraits<int> {
  static constexpr const char *text = "int";
};

template <> struct NameTraits<long> {
  static constexpr const char *text = "long";
};

template <> struct NameTraits<long long> {
  static constexpr const char *text = "long long";
};

template <> struct NameTraits<float> {
  static constexpr const char *text = "float";
};

template <> struct NameTraits<double> {
  static constexpr const char *text = "double";
};

template <> struct NameTraits<std::nullptr_t> {
...
template <typename T> struct BasicName<T, true> {
...
template <typename T> struct BasicName<T, false> {
...
template <typename Head, typename... Tail> struct Name<Head, Tail...> {
...
template <typename RT, typename... Args> struct Name<RT(Args...)> {
...
template <typename T, int N> struct Name<T[N]> {
...
template <typename T, int N> struct Name<const T[N]> {
