...
template <typename ArgList, template <typename...> class Head,
...
template <typename List>
using TReverse =
    TAccumulate<List, TPushFront, TemplateList<typename List::ArgList>>;
...
template <typename ArgList, template <template <typename...> class T> class Op,
          template <typename...> class... Ts>
...
struct TSelect {
  using type = TemplateList<typename List::ArgList,
                            TAt<List, Indices>::template Ttype...>;
};
...
struct TContainRec<List, T, false, false>
    : TContainRec<TPopFront_t<List>, T,
                  std::is_same<TInstance_t<typename List::ArgList,
                                           TFront<List>::template Ttype>,
                               TInstance_t<typename List::ArgList, T>>::value> {
};
...
template <typename List, template <typename...> class... Ts>
struct TContainList<List, TemplateList<typename List::ArgList, Ts...>>
    : Conjunction<Bool<TContain_v<List, Ts>>...> {};
